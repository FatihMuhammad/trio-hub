...
<head>
	...
	<link rel="icon" href="assets/img/fevicon.ico" type="image/ico">
    <title>Trio Hub</title>
    <!-- BOOTSTRAP STYLES-->
        ...
        <div class="navbar navbar-inverse navbar-fixed-top">
            <div class="adjust-nav">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Trio Hub</a>
                </div>
                ...
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a href="tk.php">Tiktok Downloader</a>
                            </li>
							<li>
                                <a href="tw.php">Twitter Downloader</a>
                            </li>
                            <li>
                                <a href="yt1.php">Youtube Downloader</a>
                            </li>
							<li>
